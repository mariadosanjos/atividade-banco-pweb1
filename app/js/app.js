...
let contaMaria = new Conta("001", 589);
let contaEspecialMaria = new Conta("002", 784);

let clienteMaria = new ClienteEspecial("Maria dos Anjos", "123.456.789-00", contaMaria, contaEspecialMaria);
console.log(clienteMaria);
console.log("Saldo total da cliente Maria dos Anjos: " + clienteMaria.saldoTotal() + " reais");